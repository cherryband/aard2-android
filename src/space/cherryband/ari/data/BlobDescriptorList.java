...
public final class BlobDescriptorList extends AbstractList<BlobDescriptor> {
    ...
    public BlobDescriptorList(AriApplication app, DescriptorStore<BlobDescriptor> store) {
        this(app, store, 100);
    }

    public BlobDescriptorList(AriApplication app, DescriptorStore<BlobDescriptor> store, int maxSize) {
        this.app = app;
        this.store = store;
